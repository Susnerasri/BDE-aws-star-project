...
spark.sparkContext.addPyFile("s3://sneha-landingzone-batch08/delta-core_2.12-0.8.0.jar")

from delta import *
from delta.tables import DeltaTable

app_config=spark.read.option("multiline","true").json("s3://sneha-landingzone-batch08/app config file.json").toJSON().collect()
